...
export function TimesheetDetail() {
  ...
  // Add state for submission status messages
  ...
  const handleSubmitTimesheet = async () => {
    if (!id) {
      console.log('No timesheet ID available, cannot submit');
      return;
    }
    
    console.log('Submit button clicked for timesheet ID:', id);
    ...
    console.log('Starting timesheet submission process');
    setSubmissionError(null);
    setSubmissionSuccess(null);
    
    try {
      console.log('Calling submitTimesheet action with ID:', id);
      await submitTimesheet(id);
      console.log('Timesheet submission successful');
      setSubmissionSuccess('Timesheet submitted successfully for approval.');
    } catch (err: any) {
      console.error('Timesheet submission failed:', err);
      setSubmissionError(err.message || 'Failed to submit timesheet. Please try again.');
    }
  };
